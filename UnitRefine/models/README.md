...
You can also access and download these models from the [our Curation Models Collection on Hugging Face Hub](https://huggingface.co/AnoushkaJain3).
The Huggingface collection also contains many additional models. Some of the most relevant models are:
...
Additional models from the SpikeInterface collection are also available [here](https://huggingface.co/collections/SpikeInterface/curation-models-66ebf53d7f17088991062c2c).
